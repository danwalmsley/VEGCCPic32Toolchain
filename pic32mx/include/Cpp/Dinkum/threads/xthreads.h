...
extern "C++" {	// C++ linkage
typedef int (_STDCALL *_Thrd_start_cpp_t)(void *);

inline int _Thrd_create(_Thrd_t *_Thrd, _Thrd_start_cpp_t _Fp, void *_Arg)
	{	/* create thread */
	return (_Thrd_create(_Thrd, (_Thrd_start_t)_Fp, _Arg));
	}
}	// extern "C++"

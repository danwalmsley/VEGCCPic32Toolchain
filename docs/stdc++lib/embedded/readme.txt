...
The Dinkum C/EC++ Library Reference is Copyright (c) 1992-2010
by P.J. Plauger. This code is protected by copyright. ALL
RIGHTS RESERVED.

This set of files constitutes the entire Dinkum C/EC++ Library
Reference. It is for use only by the licensed user. See the
file crit_pjp.html (reachable via the Copyright hot link at
the bottom of every page) for detailed restrictions.

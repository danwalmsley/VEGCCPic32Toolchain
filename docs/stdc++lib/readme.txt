...
The Dinkum C/C++ Library Reference is Copyright (c) 1989-2010
by P.J. Plauger. This code is protected by copyright. ALL
RIGHTS RESERVED.

This set of files constitutes the entire Dinkum C/C++ Library
Reference. It is for use only by the licensed user. See the
files crit_pb.html or crit_pjp.html (reachable via the
Copyright hot link at the bottom of every page) for detailed
restrictions.
...
“Product”, is copyright © 1989-2010 by P.J. Plauger. ALL RIGHTS

...
static __attribute__((section(".sbss.APPIO_DEBUG"))) buffer_t outbuf;
static __attribute__((section(".sbss.APPIO_DEBUG"))) unsigned int outcount;
...
static __attribute__((section(".sbss.APPIO_DEBUG"))) buffer_t inbuf;

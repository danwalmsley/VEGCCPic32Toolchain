...
CFLAGS	=$(OPTIM) $(VAR) $(GPOPT) $(DEBUG) $(ASSERT) $(EXCEPT) -ffreestanding -ffunction-sections -minterlink-mips16 -mcode-xonly -D_SUPPRESS_PLIB_WARNING
ASFLAGS	=$(OPTIM) $(VAR) $(GPOPT) $(ASSERT) $(EXCEPT) -ffreestanding -ffunction-sections -minterlink-mips16 -mcode-xonly
STRIPFLAGS =-X
ARCH	=mips

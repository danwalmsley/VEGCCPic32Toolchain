...
#define OpenADC10(config1, config2, config3, configport, configscan) (mPORTBSetPinsAnalogIn(configport), AD1CSSL = ~(configscan), AD1CON3 = (config3), AD1CON2 = (config2), AD1CON1 = (config1) )
    ...
    /********************************
     * Available options for the configport parameter
     ********************************/
...
/* Enable analog channels - Values are mutually exclusive */
  ...
  #if !defined( _DISABLE_OPENADC10_CONFIGPORT_WARNING )
    #warning "Support for configport argument for OpenADC10 not available for this device."
  #endif
  ...
  #define ENABLE_ALL_ANA            (0xFFFF)                             /*Enable AN0-AN15 in analog mode */
    ...
    /*******************************
     * Available options for the configscan parameter
     ********************************/
#if defined(__32MX120F064H__) || \
    defined(__32MX130F128H__) || \
    defined(__32MX130F128L__) || \
 ...
 #if !defined( _DISABLE_OPENADC10_CONFIGSCAN_WARNING )
    #warning "ADC Channels 32-50 not supported for configscan OpenADC10 argument for this device."
 #endif
#elif (__PIC32_FEATURE_SET__ == 330) || \
      (__PIC32_FEATURE_SET__ == 350) || \
      (__PIC32_FEATURE_SET__ == 370) || \
